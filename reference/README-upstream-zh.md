...
> 원본 `README.md`입니다. 문서 안의 상대 링크(`examples/`, `LICENSE`)는 원본 저장소
> 기준이라 이 레포에서는 열리지 않습니다. `examples/`는 이 교재와 무관해
> 가져오지 않았고, `LICENSE`는 레포 루트에 있습니다.
> 한국어 교재는 [`../README.md`](../README.md)와 [`../docs/00-개요.md`](../docs/00-개요.md)를 보세요.
